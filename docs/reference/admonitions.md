...
Please refer to the new, more powerful and flexible configuration: [Custom icons and colors](#custom-icons-and-colors).
...
If you require full custom styling for admonitions, the Additional CSS approach is more appropriate, add the following CSS to your [additional style sheet]{target="_blank"}:
